...
import br.com.voxzap.messenger.NativeCrashManager;
...
import br.com.voxzap.messenger.camera.CameraController;
...
import br.com.voxzap.ui.Adapters.DrawerLayoutAdapter;
import br.com.voxzap.ui.ActionBar.ActionBarLayout;
import br.com.voxzap.ui.ActionBar.BaseFragment;
import br.com.voxzap.ui.ActionBar.DrawerLayoutContainer;
import br.com.voxzap.ui.Cells.LanguageCell;
import br.com.voxzap.ui.Components.EmbedBottomSheet;
import br.com.voxzap.ui.Components.JoinGroupAlert;
import br.com.voxzap.ui.Components.LayoutHelper;
import br.com.voxzap.ui.Components.PasscodeView;
...
import br.com.voxzap.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("br.com.voxzap.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
