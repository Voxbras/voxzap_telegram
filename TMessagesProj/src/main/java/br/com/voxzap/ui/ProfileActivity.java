...
import br.com.voxzap.ui.Cells.AboutLinkCell;
import br.com.voxzap.ui.Cells.DividerCell;
import br.com.voxzap.ui.Cells.EmptyCell;
import br.com.voxzap.ui.Cells.LoadingCell;
import br.com.voxzap.ui.Cells.ShadowSectionCell;
import br.com.voxzap.ui.Cells.TextCell;
import br.com.voxzap.ui.Cells.TextDetailCell;
import br.com.voxzap.ui.Cells.TextInfoPrivacyCell;
import br.com.voxzap.ui.Cells.UserCell;
...
import br.com.voxzap.ui.Components.AvatarDrawable;
import br.com.voxzap.ui.Components.AvatarUpdater;
...
import br.com.voxzap.ui.Components.IdenticonDrawable;
    ...
    private boolean processOnClickOrPress(final int position) {
        if (position == usernameRow || position == channelNameRow) {
            ...
            if (MessagesController.getInstance().callsEnabled && userFull != null && userFull.phone_calls_available) {
                items.add(LocaleController.getString("CallViaVoxZap", R.string.CallViaVoxZap));
                actions.add(2);
            }
