...
package br.com.voxzap.messenger.query;
...
import br.com.voxzap.messenger.OpenChatReceiver;
        ...
        Utilities.globalQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                ...
                arrayList.add(new ShortcutInfo.Builder(ApplicationLoader.applicationContext, "compose")
                        ...
                        .setIcon(Icon.createWithResource(ApplicationLoader.applicationContext, R.drawable.ic_shortcut_compose))
                        .setIntent(intent)
                        .build());
