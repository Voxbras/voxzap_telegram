...
static const char *FileLoadOperationClassPathName = "br/com/voxzap/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "br/com/voxzap/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "br/com/voxzap/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILbr/com/voxzap/tgnet/RequestDelegateInternal;Lbr/com/voxzap/tgnet/QuickAckDelegate;Lbr/com/voxzap/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("br/com/voxzap/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("br/com/voxzap/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("br/com/voxzap/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("br/com/voxzap/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("br/com/voxzap/tgnet/ConnectionsManager"));
